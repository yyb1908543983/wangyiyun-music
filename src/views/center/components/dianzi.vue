    ...
    <div>
        ...
        <div class="list-inner">
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="8" @click.native="toSongSheet(item.id)" class="inner" v-for="item in list" :key="item.id">
...
export default {
  ...
  methods: {
    ...
    getList () {
      this.axios.get('/api/top/playList/highquality?limit=30&cat=电子').then((res) => {
